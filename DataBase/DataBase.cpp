...
void DatabaseEmpleados() {
    ...
    empleado[3] = {"Laura Silva Castro", "23456789", "10004", "Silva2023", "laurasilva@susti.com", "965432109", 38, 4000, "Tesorería", 0, 42, false};
    ...
    empleado[8] = {"Daniela Torres Peña", "78901234", "10009", "Daniela2024", "daniela@susti.com", "943210987", 36, 2900.00, "Ayudante de Tienda", 0, 40, false};
    ...
    empleado[11] = {"Sebastian Montoya", "01234567", "10012", "Sebastian2023", "sebastian@susti.com", "978901234", 30, 4000, "Tesorería", 0, 42, false};
    ...
    empleado[17] = {"Felipe Castaño Alvarez", "67890124", "10018", "Felipe2023", "felipe@susti.com", "994567890", 44, 3400.00, "Cajero", 0, 45, false};
    empleado[18] = {"Sara Castillo Vargas", "78901235", "10019", "Sara2024", "sara@susti.com", "995678901", 28, 4800.00, "Contador", 0, 42, false};
    empleado[19] = {"Luis Alejandro Gomez", "89012346", "10020", "Luis2023", "luis@susti.com", "996789012", 39, 4000, "Tesorería", 0, 42, false};
    ...
    empleado[27] = {"Manuel Torres Perez", "67890125", "10028", "Manuel2023", "manuel@susti.com", "999567890", 35, 4000, "Tesorería", 0, 42, false};
...
void DatabaseProductos () {
    producto[0] = {"Electrónica", "Televisor", "Samsung", "TV001", 550.00, 400.00, 20};
    producto[1] = {"Electrónica", "Smartphone", "Apple", "SP001", 999.00, 750.00, 15};
    producto[2] = {"Electrónica", "Auriculares", "Sony", "AU001", 150.00, 100.00, 30};
    producto[3] = {"Electrónica", "Laptop", "Dell", "LP001", 1200.00, 900.00, 10};
    producto[4] = {"Electrónica", "Cámara", "Canon", "CA001", 800.00, 600.00, 12};
    producto[5] = {"Electrodomésticos", "Refrigerador", "LG", "RF001", 700.00, 500.00, 8};
    producto[6] = {"Electrodomésticos", "Lavadora", "Bosch", "LW001", 600.00, 450.00, 7};
    producto[7] = {"Electrodomésticos", "Microondas", "Panasonic", "MC001", 120.00, 80.00, 25};
    producto[8] = {"Electrodomésticos", "Cafetera", "Krups", "CF001", 75.00, 50.00, 18};
    producto[9] = {"Electrodomésticos", "Plancha", "Philips", "PL001", 60.00, 40.00, 20};
    producto[10] = {"Muebles", "Sofá", "IKEA", "SF001", 450.00, 300.00, 10};
    ...
    producto[28] = {"Juguetes", "Juego de construcción", "LEGO", "JC001", 90.00, 60.00, 15};
    ...
    producto[35] = {"Oficina", "Silla ergonómica", "Herman Miller", "SE001", 250.00, 180.00, 12};
    producto[36] = {"Oficina", "Lámpara de escritorio", "Philips", "LA001", 80.00, 60.00, 20};
    ...
    producto[42] = {"Cuidado personal", "Champú", "Pantene", "CH002", 12.00, 8.00, 50};
